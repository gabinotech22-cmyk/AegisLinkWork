...
import { canonicalBytes, type CanonicalValue } from './canonicalJson.js';

/**
 * SHA-256 — the ONLY line that differs between the three copies of this file.
 * Each package uses the hash it already ships (`node:crypto` here,
 * `@noble/hashes` in the clients) instead of adding a dependency; the golden
