...
// ─── Step 3: Android network_security_config.xml ─────────────────────────────
//
// AegisLink Work: NO build-time SPKI pin-set in the seed. The personal edition
// pins its own relay host here; a Work client has no fixed relay at build time —
// the organization's invitation carries `relayUrl` and `relayPins`
// (docs/PROTOCOL.md §4, docs/SECURITY-PARITY.md "Certificate pinning"), and the
// client pins from that at enrolment (fase 4). The SaaS host gets a build-time
// pin-set in fase 6 when it exists. What this file still enforces today:
// cleartext forbidden everywhere except the dev loopback and .onion, and no
// user-installed roots outside debuggable builds.
const NETWORK_SECURITY_XML = `<?xml version="1.0" encoding="utf-8"?>
<!--
  Network Security Config — AegisLink Work
  Auto-generated by app.plugin.js during expo prebuild. Do not edit manually.

  No static pin-set: the relay TLS pin arrives in the organization's invitation
  (relayPins) and is enforced by the client at enrolment. See app.plugin.js.
