/**
 * ratchetSerde.test.ts — ratchet-state byte revival (mobile).
 *
 ...
 * non-byte shapes. Twin of desktop/src/renderer/socket/__tests__/ratchetSerde.test.ts.
 */
import { reviveBytes, reviveMkSkipped, isByteIndexedObject } from '../ratchetSerde';
