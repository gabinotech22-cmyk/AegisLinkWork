 ...
 * (`mobile/src/crypto/__tests__/noble-kat.test.ts`) asserts the SAME vectors
 * against its v1 build — if either platform's library ever changes output, its
 * KAT fails. Keep the two files in lock-step.
 */
